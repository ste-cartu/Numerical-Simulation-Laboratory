...
public: // Function declarations
  ...
  void write_XYZ(int nconf, const string path = "../");   // Write system configuration in XYZ format on the fly
  void write_velocities(const string path = "../");       // Write final particle velocities to file
  void read_configuration(const string path = "../");     // Read system configuration from file
  void initialize_velocities(const string path = "../");  // Initialize particle velocities
